...
class MainWindow(QMainWindow):
    ...
    def build_combobox_clients(self):
        """
        Добавление списка клиентов в Combo Box.
        """
        ...
        logging.log(logging.INFO, 'Combo Box "Клиенты" обновлён')

    def build_combobox_books(self):
        """
        Добавление списка книг в Combo Box.
        """
    ...
    def build_combobox_genre(self):
        """
        Добавление списка жанров в Combo Box.
        """
        ...
        logging.log(logging.INFO, 'Combo Box "Жанры" обновлён')
